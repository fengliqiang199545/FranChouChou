...
public class CourseServiceImpl implements CourseService {
    ...
    @Autowired
    private CourseCustomMapper courseMapperCustom;
    ...
    public CourseCustom findById(Integer id) throws Exception {
        ...
        if (course != null) {
            ...
            org.apache.commons.beanutils.BeanUtils.copyProperties(courseCustom, course);
        }
    ...
    public List<CourseCustom> findByTeacherID(Integer id) throws Exception {
        ...
        if (list.size() > 0) {
            ...
            for (Course c : list) {
                CourseCustom courseCustom = new CourseCustom();
                //类拷贝
                org.apache.commons.beanutils.BeanUtils.copyProperties(courseCustom, c);
                //获取课程名
                College college = collegeMapper.selectByPrimaryKey(c.getCollegeid());
                courseCustom.setcollegeName(college.getCollegename());
